...
class AddPokemon extends InputFilter
{
  public function __construct()
  {
      ...
      $evolution = new Input('evolution');
      $evolution->setRequired(true);
      $evolution->setFilterChain($this->getStringTrimFilterChain());
      $evolution->setValidatorChain($this->geEvolutionValidatorChain());
  ...
  protected function geEvolutionValidatorChain()
  {
      $validatorChain = new ValidatorChain();
      $validatorChain->attach(new Digits(true));
      $validatorChain->attach(new GreaterThan(['min' => 0, 'inclusive' => true]));
